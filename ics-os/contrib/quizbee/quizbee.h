...
//             write_text(question,20,40,YELLOW,0);
//             write_text(choice1,20,60,YELLOW,0);
//             write_text(choice2,20,80,YELLOW,0);
//             write_text(choice3,20,100,YELLOW,0);
//             write_text(choice4,20,120,YELLOW,0);
//             write_text(answer,20,140,YELLOW,0);
...
//         write_text("File not found.",20,80,YELLOW,0);
// 	}
// }
